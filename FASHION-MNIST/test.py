...
logging.basicConfig(filename='logs/K-Fedtrust00.log', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
...
if __name__ == "__main__":
    ...
    plt.savefig(os.path.join(res_dir, 'OURfl持续.png'))