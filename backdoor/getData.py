...
class GetDataSet(object):
    ...
    def apply_trigger_to_test(self, trigger_pattern):
        self.test_data = trigger_pattern(self.test_data)

    def mnistDataSetConstruct(self, isIID):
        data_dir = r'/home/LvYongyang/FedLabs/FLTrust-attack/data/MNIST'
