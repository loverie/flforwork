...
parser.add_argument('-atp', '--attack_type', type=int, default=5, help='the  attack type 0-consistent 2-groupappart 3-flag')
parser.add_argument('-att', '--attack_turn', type=int, default=10, help='the num of turns to attack')
parser.add_argument('-atn', '--attack_num', type=int, default=10, help='the num of clients to attack')
...
if __name__ == "__main__":
    ...
    # print(attack_rounds)
    #minist/cifar10
    myClients = ClientsGroup('har', args['IID'], args['num_of_clients'], dev,attack_rounds=attack_rounds)
    tempGroup=myClients
